...
\submissiondate{July 8, 2016}
\publicationdate{July 8, 2016}
...
Toolkit\footnote{\url{http://odetoolkit.hmc.edu}} to
...
policy\footnote{\url{http://scholarship.claremont.edu/codee/policies.html}}. The
editorial policy describes the various kinds of manuscripts that are
accepted by the \emph{CODEE Journal}, the criteria will be used to
review your manuscript, and the submission process.
